...
|---|---|---|
| `@elchika-inc/moonqr/encode` | Encode only | raw 25.0 KB / gzip 7.5 KB |
| `@elchika-inc/moonqr/decode` | Decode only | raw 129.6 KB / gzip 49.8 KB |
| `@elchika-inc/moonqr/dom` | `toCanvas` (canvas rendering) | raw 0.3 KB / gzip 0.2 KB (no MoonBit dependency) |
| `@elchika-inc/moonqr` | Everything (convenience) | raw 154.7 KB / gzip 57.7 KB |
