...
export const translations = {
  en: {
    ...
    "hero.badge3": "7.2 KB gzip encoder",
    ...
    "numbers.encodeDesc":
      "Cell-for-cell match against the qrcode npm package across every version × EC-level combination. Mixed-mode optimization shrinks a 100-digit URL from v7 to v4.",
    "numbers.bundleTitle": "Bundle size",
    "numbers.bundleValue": "7.2 KB / ~50 KB",
    "numbers.bundleDesc":
  ...
  ja: {
    ...
    "numbers.encodeValue": "160 / 160",
    "numbers.encodeDesc":
      "qrcode npmパッケージと全バージョン×ECレベルの組み合わせでセル単位一致。混在モード最適化により100桁IDのURLをv7からv4へ縮小。",
    "numbers.bundleTitle": "バンドルサイズ",
    "numbers.bundleValue": "7.2KB / 約50KB",
    "numbers.bundleDesc":
